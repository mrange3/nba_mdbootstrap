    ...
    .then(function (nflSchedule) {
      ...
      for (i = 0; i < nflSchedule.references.gameReferences.length; i++) {
        ...
        if (nflSchedule.references.gameReferences[i].week == x) {
          ...
          htmlString += '<td class="col-3 text-left mobileHide pl-3 py-1 font-weight-bold" style=" font-size: 12px;"><img  src="images/nfl_logos/' + aTeam + '.png" height="20px" width="20px"> ' + awayMoneyLine + '</td>';
          ...
          htmlString += '<td class="col-3 py-1 pl-3 mobileHide font-weight-bold text-left"  style=" font-size: 12px;"><img  src="images/nfl_logos/' + hTeam + '.png" height="20px" width="20px"> ' + homeMoneyLine + '</td>';
          ...
          htmlString += '<td class="col-3 mobileHide text-left pl-3 py-1 font-weight-bold" style=" font-size: 12px;"><img  src="images/nfl_logos/' + aTeam + '.png" height="20px" width="20px"> ' + awaySpreadLine + '</td>';
          ...
          htmlString += '<td class="col text-center px-0 py-1 font-weight-bold"  style=" font-size: 12px;"></td>';
          htmlString += '<td class="col  text-center px-0 py-1 font-weight-bold text-light " style=" font-size: 12px;"></td>';
          htmlString += '<td class="col-3 mobileHide py-1 pl-3 font-weight-bold text-left"  style=" font-size: 12px;"><img  src="images/nfl_logos/' + hTeam + '.png" height="20px" width="20px"> ' + homeSpreadLine + '</td>';
          ...
          htmlString += '<td class="col-3 text-left mobileHide pl-3 py-1 font-weight-bold" style=" font-size: 12px;"><img  src="images/nfl_logos/' + aTeam + '.png" height="20px" width="20px"> ' +aMoneyLine+ '</td>';
          ...
          htmlString += '<td class="col text-center px-0 py-1 font-weight-bold"  style=" font-size: 12px;"></td>';
          htmlString += '<td class="col  text-center px-0 py-1 font-weight-bold text-light " style=" font-size: 12px;"></td>';
          htmlString += '<td class="col-3 py-1 pl-3 mobileHide font-weight-bold text-left"  style=" font-size: 12px;"><img  src="images/nfl_logos/' + hTeam + '.png" height="20px" width="20px"> '+hMoneyLine+ '</td>';
          ...
          htmlString += '<td class="col-3 mobileHide text-left pl-3 py-1 font-weight-bold" style=" font-size: 12px;">' + overUnder + '</td>';
          htmlString += '<td class="col-3 deskHide text-left pl-1 py-1 font-weight-bold" style=" font-size: 12px;">' + overUnder + '</td>';
          htmlString += '<td class="col text-center px-0 py-1 font-weight-bold"  style=" font-size: 12px;"></td>';
          htmlString += '<td class="col  text-center px-0 py-1 font-weight-bold text-light " style=" font-size: 12px;"></td>';
          htmlString += '<td class="col-3 mobileHide py-1 pl-3 font-weight-bold text-left"  style=" font-size: 12px;">' + overUnder + '</td>';
          ...
          htmlString += '<td class="col-3 mobileHide text-left pl-3 py-1 font-weight-bold border-bottom" style=" font-size: 12px;"><img  src="images/nfl_logos/' + aTeam + '.png" height="20px" width="20px"> 1.</td>';
