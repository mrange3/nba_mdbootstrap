    ...
    .then(function (nflSchedule) {
      ...
      for (i = 0; i < nflSchedule.references.gameReferences.length; i++) {
        ...
        if (nflSchedule.references.gameReferences[i].week == x) {
          ...
          htmlString += '<td class="col-3 text-left mobileHide pl-3 py-1 font-weight-bold" style=" font-size: 12px;">' + awayMoneyLine + '</td>';
          htmlString += '<td class="col-3 text-left deskHide pl-1 py-1 font-weight-bold" style=" font-size: 12px;">' + awayMoneyLine + '</td>';
          ...
          htmlString += '<td class="col-3 py-1 pl-3 mobileHide font-weight-bold text-left"  style=" font-size: 12px;">' + homeMoneyLine + '</td>';
          htmlString += '<td class="col-3 py-1 px-1 deskHide font-weight-bold text-left"  style=" font-size: 12px;">' + homeMoneyLine + '</td>';
          htmlString += '<td class="col text-center px-0 py-1 font-weight-bold"  style=" font-size: 12px;"></td>';
          htmlString += '<td class="col  text-center px-0  py-1 font-weight-bold text-light "  style=" font-size: 12px;"> </td>';
          ...
          htmlString += '<td class="col-3 mobileHide text-left pl-3 py-1 font-weight-bold" style=" font-size: 12px;">' + awaySpreadLine + '</td>';
          htmlString += '<td class="col-3 deskHide text-left pl-1 py-1 font-weight-bold" style=" font-size: 12px;">' + awaySpreadLine + '</td>';
          htmlString += '<td class="col text-center px-0 py-1 font-weight-bold"  style=" font-size: 12px;"></td>';
          htmlString += '<td class="col  text-center px-0 py-1 font-weight-bold text-light " style=" font-size: 12px;"></td>';
          htmlString += '<td class="col-3 mobileHide py-1 pl-3 font-weight-bold text-left"  style=" font-size: 12px;">' + homeSpreadLine + '</td>';
          htmlString += '<td class="col-3 deskHide py-1 px-1 font-weight-bold text-left"  style=" font-size: 12px;">' + homeSpreadLine + '</td>';
          htmlString += '<td class="col text-center px-0 py-1 font-weight-bold"  style=" font-size: 12px;"></td>';
          htmlString += '<td class="col  text-center px-0  py-1 font-weight-bold text-light "  style=" font-size: 12px;"> </td>';
          htmlString += '<td class="col text-center font-weight-bold text-primary py-1 pr-3"  style=" font-size: 12px;"></td>';
          htmlString += '</tr>';
          ...
          htmlString += '<td class="col-3 text-left mobileHide pl-3 py-1 font-weight-bold" style=" font-size: 12px;">' +aMoneyLine+ '</td>';
          htmlString += '<td class="col-3 text-left deskHide pl-1 py-1 font-weight-bold" style=" font-size: 12px;">' +aMoneyLine+ '</td>';
          htmlString += '<td class="col text-center px-0 py-1 font-weight-bold"  style=" font-size: 12px;"></td>';
          htmlString += '<td class="col  text-center px-0 py-1 font-weight-bold text-light " style=" font-size: 12px;"></td>';
          htmlString += '<td class="col-3 py-1 pl-3 mobileHide font-weight-bold text-left"  style=" font-size: 12px;">'+hMoneyLine+ '</td>';
          htmlString += '<td class="col-3 py-1 px-1 deskHide font-weight-bold text-left"  style=" font-size: 12px;">'+hMoneyLine+ '</td>';
          htmlString += '<td class="col text-center px-0 py-1 font-weight-bold"  style=" font-size: 12px;"></td>';
          htmlString += '<td class="col  text-center px-0  py-1 font-weight-bold text-light "  style=" font-size: 12px;"> </td>';
          htmlString += '<td class="col text-center font-weight-bold text-primary py-1 pr-3"  style=" font-size: 12px;"></td>';
          htmlString += '</tr>';
          ...
          htmlString += '<td class="col-3 mobileHide text-left pl-3 py-1 font-weight-bold border-bottom" style=" font-size: 12px;">1.</td>';
          htmlString += '<td class="col-3 deskHide text-left pl-1 py-1 font-weight-bold border-bottom" style=" font-size: 12px;">1.</td>';
          htmlString += '<td class="col text-center px-0 py-1 font-weight-bold"  style=" font-size: 12px;"></td>';
          htmlString += '<td class="col  text-center px-0 py-1 font-weight-bold text-light " style=" font-size: 12px;"></td>';
          htmlString += '<td class="col-3 mobileHide py-1 px-2 font-weight-bold text-left border-bottom"  style=" font-size: 12px;">1.</td>';
          htmlString += '<td class="col-3 deskHide text-left px-1 py-1 font-weight-bold border-bottom" style=" font-size: 12px;">1.</td>';
          htmlString += '<td class="col text-center px-0 py-1 font-weight-bold"  style=" font-size: 12px;"></td>';
          htmlString += '<td class="col  text-center px-0  py-1 font-weight-bold text-light "  style=" font-size: 12px;"> </td>';
          htmlString += '<td class="col text-center font-weight-bold text-primary py-1 pr-3"  style=" font-size: 12px;"></td>';
          htmlString += '</tr>';
          ...
          htmlString += '<td class="col  text-center px-0 py-1 font-weight-bold text-light " style=" font-size: 12px;"></td>';
          htmlString += '<td class="col-3 mobileHide py-1 px-2 font-weight-bold text-left border-bottom"  style=" font-size: 12px;">1.</td>';
          htmlString += '<td class="col-3 deskHide py-1 px-1 font-weight-bold text-left border-bottom"  style=" font-size: 12px;">1.</td>';
          htmlString += '<td class="col text-center px-0 py-1 font-weight-bold"  style=" font-size: 12px;"></td>';
          htmlString += '<td class="col  text-center px-0  py-1 font-weight-bold text-light "  style=" font-size: 12px;"> </td>';
          htmlString += '<td class="col text-center font-weight-bold text-primary py-1 pr-3"  style=" font-size: 12px;"></td>';
          htmlString += '</tr>';
          ...
          htmlString += '<td class="col-3 text-left pl-1 py-1 font-weight-bold border-bottom" style=" font-size: 12px;"></td>';
          htmlString += '<td class="col text-center px-0 py-1 font-weight-bold"  style=" font-size: 12px;"></td>';
          htmlString += '<td class="col  text-center px-0 py-1 font-weight-bold text-light border bg-dark" style=" font-size: 12px;">0</td>';
          htmlString += '<td class="col-3 py-1 px-2 font-weight-bold text-left border-bottom"  style=" font-size: 12px;"></td>';
          htmlString += '<td class="col text-center px-0 py-1 font-weight-bold"  style=" font-size: 12px;"></td>';
          htmlString += '<td class="col  text-center px-0  py-1 font-weight-bold text-light border bg-dark"  style=" font-size: 12px;">0</td>';
