    ...
    .then(function (standings) {
        ...
        for (j = 0; j < standings.teams.length; j++) {
            ...
            if (standings.teams[j].playoffRank.conferenceName == "Western") {
                ...
                standingsStringW += '<th class="dateFont mainDate align-middle clickHide text-left py-0 pl-0 pr-1 text-nowrap boxtable dateFont" style="font-size: 18px;"><img class=" smallLogo" src="images/logos/' + tLogo + '.png" >'+ " " +teamStandingsAbv+ '</th>'
                standingsStringW += '<th  class="dateFont   align-middle text-left py-0 pl-0 pr-1 text-nowrap boxtable dateFont westernStats collapse" style="font-size: 18px;"><img class=" smallLogo" src="images/logos/' + tLogo + '.png" >'+ " " +standings.teams[j].team.city+ " " + standings.teams[j].team.name+'</th>'
                standingsStringW += '<th class="dateFont mainDate align-middle text-center py-0 px-1 teamstatsData dateFont " style="font-size: 18px;">' + standings.teams[j].stats.standings.wins + "-" + standings.teams[j].stats.standings.losses +'</th>'
                ...
                standingsStringE += '<th class="dateFont mainDate align-middle clickHide2 text-left py-0  pl-0 pr-1 text-nowrap boxteam boxtable dateFont" style="font-size: 18px;"><img class="p-0 m-0 smallLogo" src="images/logos/' + tLogo + '.png" >'+ " " +teamStandingsAbv  + '</th>'
                standingsStringE += '<th  class="dateFont mainDate collapse easternStats align-middle text-left py-0 pl-0 pr-4 text-nowrap boxtable dateFont" style="font-size: 18px;"><img class=" smallLogo" src="images/logos/' + tLogo + '.png" >'+ " " +standings.teams[j].team.city+ " " + standings.teams[j].team.name+'</th>'
                standingsStringE += '<th class="dateFont mainDate align-middle text-center py-0 px-1 teamstatsData dateFont" style="font-size: 18px;">' + standings.teams[j].stats.standings.wins + "-" + standings.teams[j].stats.standings.losses +'</th>'
