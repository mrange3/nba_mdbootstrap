    ...
    .then(function (standings) {
        ...
        for (j = 0; j < standings.teams.length; j++) {
            ...
            if (standings.teams[j].playoffRank.conferenceName == "Western") {
                var standingsStringW = '<td class="align-middle text-center py-0 px-1 m-0 font-weight-bold" style="font-size: 10px;">'+ playoffSeed + '</td>'
                standingsStringW += '<th class="align-middle text-left py-0 pl-0 pr-1 text-nowrap boxtable" style="font-size: 16px;"><img class=" smallLogo" src="images/logos/' + tLogo + '.png" >'+ " " +standings.teams[j].team.abbreviation+ '</th>'
                standingsStringW += '<td class="align-middle text-center py-0 px-1 teamstatsData">' + standings.teams[j].stats.standings.wins + "-" + standings.teams[j].stats.standings.losses +'</td>'
                ...
                var standingsStringE = '<td class="align-middle text-center py-0 px-1 m-0 font-weight-bold" style="font-size: 10px;">'+ playoffSeed + '</td>'
                standingsStringE += '<th class="align-middle text-left py-0 pl-0 pr-1 text-nowrap boxteam boxtable" style="font-size: 16px;"><img class="p-0 m-0 smallLogo" src="images/logos/' + tLogo + '.png" >'+ " " +standings.teams[j].team.abbreviation  + '</th>'
                standingsStringE += '<td class="align-middle text-center py-0 px-1 teamstatsData">' + standings.teams[j].stats.standings.wins + "-" + standings.teams[j].stats.standings.losses +'</td>'
