    ...
    .then(function (standings) {
        ...
        for (j = 0; j < standings.teams.length; j++) {
            ...
            if (standings.teams[j].playoffRank.conferenceName == "Western") {
                ...
                standingsStringW += '<th class="align-middle text-center py-0 px-1 teamstatsData" style="font-size: 18px;">' + standings.teams[j].stats.standings.wins + "-" + standings.teams[j].stats.standings.losses +'</th>'
                ...
                standingsStringE += '<th class="align-middle text-center py-0 px-1 teamstatsData" style="font-size: 18px;">' + standings.teams[j].stats.standings.wins + "-" + standings.teams[j].stats.standings.losses +'</th>'
