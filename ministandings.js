    ...
    .then(function (standings) {
        ...
        for (j = 0; j < standings.teams.length; j++) {
            ...
            if (standings.teams[j].playoffRank.conferenceName == "Western") {
                ...
                miniStandingsStringW += '<td class="align-middle text-left pl-0 pt-1 pb-1" style="font-size: 13px;"><img src="images/logos/' + tLogo + '.png" height="18px" width="18px">'+ " " +standings.teams[j].team.city + " " + standings.teams[j].team.name + '</td>'
                ...
                miniStandingsStringE += '<td class="align-middle text-left pl-0 pt-1 pb-1" style="font-size: 13px;"><img src="images/logos/' + tLogo + '.png" height="18px" width="18px">'+ " " +standings.teams[j].team.city + " " + standings.teams[j].team.name + '</td>'
